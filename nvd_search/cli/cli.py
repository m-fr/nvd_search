...
@handle_exceptions
@click.argument("cpe")
@click.option("-s", "--start", type=str, help="First product version to be included in search")
@click.option("-e", "--end", type=str, help="First product version to be excluded from search")
def version(start: str, end: str, cpe: str):
